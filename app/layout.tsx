...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/opengraph-image?v=2", width: 1200, height: 630, alt: "EDITH — The interface for AI agents in the real world" }],
  },
  twitter: { card: "summary_large_image", title: "EDITH — The Interface for AI Agents in the Real World", description: "See. Hear. Remember. Delegate. Act.", images: ["/opengraph-image?v=2"] },
};
